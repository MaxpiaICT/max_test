...
export default function Footer() {
  ...
  return (
    <footer className="bg-gray-100 pt-8">
      <div className="mx-auto w-full max-w-6xl px-6 grid md:grid-cols-12 gap-8">
        {/* Logo & Company Info */}
        <div className="md:col-span-4">
          ...
          <p className="text-sm text-gray-700 font-semibold mb-4"><a href='https://sites.google.com/view/maxictprivacypolicy?usp=sharing' target='_blank'>[개인정보처리방침]</a> | <a href='https://sites.google.com/view/maxicttermsofservice?usp=sharing' target='_blank'>[이용약관]</a></p>
        </div>
      ...
      {/* Bottom copyright */}
      <div className="mx-auto w-full max-w-6xl px-6 mt-8 pb-6">
        <hr className="border-gray-300 mb-4" />
        <p className="text-center text-sm text-gray-500">
          © 2025 (주)맥스피아아이시티. All rights reserved.
        </p>
      </div>
    </footer>
  )
