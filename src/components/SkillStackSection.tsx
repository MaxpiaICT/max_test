  ...
  const skillCards = [
    {
      ...
      title: "풍부한 경험과 전문성",
      description: "2016년부터 블록체인 기반 금융 솔루션, 가상 서버 운영, 암호화폐 노드 운영 등 다양한 분야에서 축적된 노하우"
    },
    {
      id: 2,
    ...
    },
    {
      ...
      title: "안정적인 노드 운영 인프라",
      description: "전문 인력 배치와 지속적인 설비 점검, 법적·규정에 부합하는 노드 운영으로 신뢰도 높은 위탁 노드 운영 서비스 제공"
    },
    {
      id: 4,
    ...
    <section className="bg-[##FBFAFA] text-[#545F5F] py-20 h-auto">
      <div className="mx-[10%]">
        ...
        <p className="text-lg leading-[170%]">
          블록체인 기반 금융 솔루션, 가상 서버 운영, 암호화폐 노드 운영 등 다양한 분야에서 꾸준히 성장해온 IT 전문 기업입니다. <br />
          체계적인 시스템 통합 운영과 차별화된 기술력, 안정적인 노드 운영 인프라를 기반으로 고객 중심의 블록체인 서비스를 제공합니다. <br />
