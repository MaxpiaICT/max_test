  ...
  const histories = [
    {
      period: '2016',
      details: [
        '㈜태강마이닝핀테크 설립 / 비트코인(BTC) 노드 운영',
        '질소가스냉각 노드 운영 시스템 외 2건을 개발하여 특허 출현',
    ...
    },
    {
      ...
      details: [
        ...
        'IPFS 생태계 구축 서비스, 제공자로서의 원스톱 노드 운영, 클라우드 스토리지,\n\u00A0\u00A0\u00A0\u00A0\u00A0분산형 웹 애플리케이션 등 통합서비스로 기업형 노드 운영에 주력'
    ]
    },
    {
      period: '2022',
        ...
        {activeTab === 0 && (
          <>
            ...
            <div className="my-20 px-4">
              <div className="relative w-full max-w-6xl mx-auto" style={{ height: '120px' }}>
                {/* 타임라인 선 */}
                ...
                <div className="relative h-full flex items-center justify-between">
                  ...
                  <div className="flex flex-col items-center group cursor-pointer">
                    <div className="w-4 h-4 rounded-full bg-gray-600 mb-2 transition-all duration-300 group-hover:scale-150 group-hover:shadow-lg" />
                    <span className="text-sm text-gray-400 transition-all duration-300 group-hover:text-gray-600 group-hover:font-semibold">2016</span>
                  </div>
                  
                  {/* 2017 */}
                  <div className="flex flex-col items-center group cursor-pointer">
                    <div className="w-4 h-4 rounded-full bg-gray-300 mb-2 transition-all duration-300 group-hover:scale-150 group-hover:shadow-lg" />
                    <span className="text-sm text-gray-400 transition-all duration-300 group-hover:text-gray-600 group-hover:font-semibold">2017</span>
                  </div>
                  
                  {/* 2019 */}
                  <div className="flex flex-col items-center group cursor-pointer">
                    <div className="w-4 h-4 rounded-full bg-gray-200 mb-2 transition-all duration-300 group-hover:scale-150 group-hover:shadow-lg" />
                    <span className="text-sm text-gray-400 transition-all duration-300 group-hover:text-gray-600 group-hover:font-semibold">2019</span>
                  </div>
                  
                  {/* 2020 */}
                  <div className="flex flex-col items-center group cursor-pointer">
                    <div className="w-4 h-4 rounded-full bg-[#04AAAB] mb-2 transition-all duration-300 group-hover:scale-150 group-hover:shadow-lg group-hover:shadow-[#04AAAB]/50" />
                    <span className="text-sm text-gray-400 transition-all duration-300 group-hover:text-[#04AAAB] group-hover:font-semibold">2020</span>
                  </div>
                  
                  {/* 2022 */}
                  <div className="flex flex-col items-center group cursor-pointer">
                    <div className="w-4 h-4 rounded-full bg-[#04AAAB] mb-2 transition-all duration-300 group-hover:scale-150 group-hover:shadow-lg group-hover:shadow-[#04AAAB]/50" />
                    <span className="text-sm text-gray-400 transition-all duration-300 group-hover:text-[#04AAAB] group-hover:font-semibold">2022</span>
                  </div>
                  
                  {/* 2023-2024 */}
                  <div className="flex flex-col items-center group cursor-pointer">
                    <div className="relative">
                      <div className="absolute inset-0 w-6 h-6 bg-[#04AAAB] rounded-full opacity-50 blur-md transform -translate-x-1 -translate-y-1 transition-all duration-300 group-hover:opacity-75 group-hover:scale-125" />
                      <div className="w-4 h-4 rounded-full bg-[#04AAAB] relative z-10 mb-2 transition-all duration-300 group-hover:scale-150 group-hover:shadow-lg group-hover:shadow-[#04AAAB]/50" />
                    </div>
                    <span className="text-sm text-[#04AAAB] font-medium transition-all duration-300 group-hover:font-bold">2023-2024</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      {activeTab === 2 && (
            <section 
                ...
                <div className="mx-auto max-w-6xl px-6 flex justify-center">
                    <Image src="/img_about_tab3.png" alt="설립 목적 그래픽" width={2000} height={2000} className="w-full md:w-[60%] h-auto" />
                </div>
            </section>
      )}
